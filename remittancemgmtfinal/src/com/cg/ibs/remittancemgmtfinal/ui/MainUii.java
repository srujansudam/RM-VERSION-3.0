...
import com.cg.ibs.remittancemgmtfinal.service.BeneficiaryAccountService;
import com.cg.ibs.remittancemgmtfinal.service.BeneficiaryAccountServiceImpl;
import com.cg.ibs.remittancemgmtfinal.service.CreditCardService;
import com.cg.ibs.remittancemgmtfinal.service.CreditCardServiceImpl;

public class MainUii {
	...
	public void addOrModifyBeneficiary() throws RmExceptions {
		...
		do {
			...
			case 2:
				...
				do {
				System.out
						.println("Enter 1 to change Account Holder Name\n2 to change IFSC code\n3to change bank name");
				...
				case 1:
					...
					boolean validName = beneficiaryAccountService.validateBeneficiaryAccountNameOrBankName(ifscValue);

					if (validName == true) {
						beneficiaryAccountService.modifyBeneficiaryAccountDetails(choiceToModify, uci, ifscValue,
				...
				case 3:
					...
					if (validbankName == true) {
						beneficiaryAccountService.modifyBeneficiaryAccountDetails(choiceToModify, uci, bankNameNewValue,
								accountNumberToModify);
					} else {
			...
			case 3:
				...
				beneficiaryAccountService.deleteBeneficiaryAccountDetails(deleteUCI, deleteAccountNum);
				break;
			default:
				System.out.println("Please enter a valid choice");
				beneficiaryOption = 0;
